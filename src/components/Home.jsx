  ...
  return (
    <div className=' w-full  h-8/10 md:h-screen pt-5 flex flex-col  justify-center items-center   overflow-x-hidden'>
     ...
     <div className='w-full h-8/10 md:h-7/10'>
      <div className='home-img w-full  md:w-6/10 h-99 md:h-full  mx-auto'>

      <img className='' src="/shivayenterprises_Logo.jpg" alt="" />
      </div>
     </div>
     <div>
     ...
     <h3 className='text-2xl text-center'>Call Now Service Center <br />+91 9109298201</h3>
     </div>
